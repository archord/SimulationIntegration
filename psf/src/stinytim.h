...
typedef struct paramstruct {
	...
	char    parmConfiglfile[MAX_STRING]; /*configure file, use to instand the several ask process*/
...
int Read_pupil_file( paramstruct *paraminfo ,  PARMCONFIGFILE *parm, char *errorMessage );
